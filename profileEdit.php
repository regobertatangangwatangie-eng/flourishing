                ...
                <header>
                    <span class="image left">
                        <img src="<?php echo 'images/profileImages/'.htmlspecialchars($_SESSION['picName']).'?'.mt_rand(); ?>" 
                             class="img-circle img-responsive" height="200px" alt="Profile Picture">
                    </span>
                    <br>
                ...
                <form method="post" action="Profile/updateProfile.php">
                    <div class="row uniform">
                        <div class="8u 12u$(xsmall)">
                            <input type="text" name="name" id="name" value="<?php echo htmlspecialchars($_SESSION['Name']); ?>" placeholder="Full Name" required />
                        </div>
                        <div class="4u 12u$(xsmall)">
                            <input type="text" name="mobile" id="mobile" value="<?php echo htmlspecialchars($_SESSION['MobileNo']); ?>" placeholder="Mobile No" required/>
                        </div>
                        <div class="6u 12u$(xsmall)">
                            <input type="text" name="uname" id="uname" value="<?php echo htmlspecialchars($_SESSION['Username']); ?>" placeholder="Username" required/>
                        </div>
                        <div class="6u 12u$(xsmall)">
                            <input type="email" name="email" id="email" value="<?php echo htmlspecialchars($_SESSION['Email']); ?>" placeholder="Email" required/>
                        </div>
                        <div class="6u 12u$(xsmall)">
                            <div class="select-wrapper">
                                <select name="section" id="section">
                                    <option value="<?php echo htmlspecialchars($_SESSION['Section']); ?>">
                        ...
                        <div class="6u 12u$(xsmall)">
                            <input type="text" name="post" id="post" value="<?php echo htmlspecialchars($_SESSION['Post']); ?>" placeholder="Post Name" required/>
                        </div>
                        ...
                        <div class="2u 12u$(small)">
                            ...
                            <label for="year1">1<sup>st</sup> Year</label>
                        </div>
                        <div class="2u 12u$(small)">
                            <input type="radio" id="year2" name="year" value="2">
                            <label for="year2">2<sup>nd</sup> Year</label>
                        </div>
                        <div class="2u 12u$(small)">
                            <input type="radio" id="year3" name="year" value="3">
                            <label for="year3">3<sup>rd</sup> Year</label>
                        </div>
                        <div class="2u 12u$(small)">
                            <input type="radio" id="year4" name="year" value="4">
                            <label for="year4">4<sup>th</sup> Year</label>
                        </div>
